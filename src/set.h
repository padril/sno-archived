...
public:
	...
	static const long MAX_ATTEMPTS;
	...
	Set(std::deque<T> values) : elements(truncate(values).elements) {}
	~Set() {}

	// dynamically initialized
	Set(bool (*mask)(T x), int attempts = MAX_ATTEMPTS, float grain = DEFAULT_GRAIN) {
...
template <class T> const long Set<T>::MAX_ATTEMPTS = 1000000;
